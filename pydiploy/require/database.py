...
def install_postgres_server(update=False):
    ...
    #TODO: if deployed app is a django webapp extract settings file to build env vars !!!
    fabtools.require.postgres.server()
    fabtools.require.postgres.user(env.default_db_user, env.default_db_password)
    fabtools.require.postgres.database(env.default_db_name, owner=env.default_db_user)
