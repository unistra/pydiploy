...
from pydiploy.django import application_packages, pre_install_django_app_nginx_circus, deploy, rollback, post_install
...
class ReleasesManagerCheck(TestCase):
    ...
    def test_application_packages(self, api_execute, deb_packages):
        ...
        self.assertTrue(str(api_execute.call_args_list[3]).find('call(<function circus_pkg') == 0)


    @patch('fabric.api.execute', return_value=Mock())
    def test_pre_install_django_app_nginx_circus(self, api_execute):
        pre_install_django_app_nginx_circus()
        self.assertTrue(api_execute.called)
        ...
        self.assertTrue(str(api_execute.call_args_list[6]).find('call(<function virtualenv') == 0)
        self.assertTrue(str(api_execute.call_args_list[7]).find('call(<function nginx_pkg') == 0)
    ...
    def test_deploy(self, api_execute):
        ...
        self.assertTrue(str(api_execute.call_args_list[6]).find('call(<function nginx_reload') == 0)
    ...
    def test_rollback(self, api_execute):
        ...
        self.assertTrue(str(api_execute.call_args_list[1]).find('call(<function nginx_reload') == 0)



    @patch('fabric.api.execute', return_value=Mock())
    def test_post_install(self, api_execute):
        post_install()

        self.assertTrue(api_execute.called)
        self.assertTrue(str(api_execute.call_args_list[0]).find('call(<function app_circus_conf') == 0)
        self.assertTrue(str(api_execute.call_args_list[1]).find('call(<function upstart') == 0)
        self.assertTrue(str(api_execute.call_args_list[2]).find('call(<function app_reload') == 0)
        self.assertTrue(str(api_execute.call_args_list[3]).find('call(<function web_static_files') == 0)
        self.assertTrue(str(api_execute.call_args_list[4]).find('call(<function web_configuration') == 0)
        self.assertTrue(str(api_execute.call_args_list[5]).find('call(<function nginx_reload') == 0)