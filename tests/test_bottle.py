...
class ReleasesManagerCheck(TestCase):
    ...
    def test_deploy_backend(self, api_execute):
        ...
        self.assertTrue(
            str(api_execute.call_args_list[2]).find('call(<function deploy_wsgi_file')
            == 0
        )
        self.assertTrue(
        ...
        self.assertTrue(
            str(api_execute.call_args_list[4]).find('call(<function app_settings') == 0
        )
        self.assertTrue(
            str(api_execute.call_args_list[5]).find(
                'call(<function deploy_environ_file'
            )
            == 0
        )
        self.assertTrue(
            str(api_execute.call_args_list[6]).find('call(<function bottle_prepare')
            == 0
        )
        self.assertTrue(
