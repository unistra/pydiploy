...
from pydiploy.require.databases.mysql import install_mysql_client
from pydiploy.require.databases.oracle import install_oracle_client
from pydiploy.require.databases.postgres import (install_postgres_server,
                                                   postgres_pkg)
