...
from pydiploy.require.system import (
    add_group, add_user, check_python3_install, install_extra_packages,
    install_extra_ppa, install_extra_source, package_installed,
    permissions, set_locale, set_timezone, update_pkg_index,
)
...
class SystemCheck(TestCase):
    ...
    def test_set_timezone(self, api_sudo, distrib_id, is_link):
        ...
        self.assertEqual(
            api_sudo.call_args,
            call('cp -f /usr/share/zoneinfo/mytimezone /etc/localtime'),
        )
    ...
    def test_set_timezone_link(self, api_sudo, distrib_id, is_link):
        ...
        self.assertEqual(
            api_sudo.call_args,
            call('ln -sf /usr/share/zoneinfo/mytimezone /etc/localtime'),
        )
